...
import com.brook.example.utils.lang.ArrayUtil;
...
public interface Strs {
     ...
     */
    static String nullToDefault(String str, String defaultStr) {
     ...
     */
    static String trim(String str, int mode) {
        if (str == null) {
            return null;
        }
     ...
     * @return 是否以指定字符串结尾
     */
    static boolean endWithIgnoreCase(String str, String suffix) {
     ...
     * @return 是否以指定字符串结尾
     */
    static boolean endWith(String str, String suffix, boolean isIgnoreCase) {
        if (isIgnoreCase) {
     ...
     * @return 是否包含
     */
    static boolean containsIgnoreCase(String str, String testStr) {
        if (null == str) {
            // 如果被监测字符串和
     ...
     */
    static String getGeneralField(String getOrSetMethodName) {
     ...
     */
    static String removePreAndLowerFirst(String str, int preLength) {
        if (str == null) {
            return null;
        }
     ...
     * @return 处理后的字符串
     */
    static String upperFirstAndAddPre(String str, String preString) {
     ...
     * @return 字串
     */
    static String sub(String string, int fromIndex, int toIndex) {
     ...
     * @return getXxx
     */
    static String genGetter(String fieldName) {
     ...
     * @return 移除后的字符串
     */
    static String removeAll(String str, CharSequence strToRemove) {
     ...
     * @return 处理后的字符串，不符合规范返回null
     */
    static String removePreAndLowerFirst(String str, String prefix) {
     ...
     */
    static String removeSufAndLowerFirst(String str, String suffix) {
     ...
     * @return 切割后的字符串
     */
    static String subPre(String string, int toIndex) {
     ...
     * @return 清理后的字符串
     */
    static String cleanBlank(String str) {
        if (str == null) {
            return null;
        }
     ...
     * @return 切分后的集合
     */
    static String[] splitToArray(String str, char separator) {
     ...
     * @return 切分后的集合
     */
    static List<String> split(String str, char separator, int limit) {
        if (str == null) {
            return null;
        }
     ...
     * @return 切分后的集合
     */
    static String[] splitToArray(String str, char separator, int limit) {
     ...
     * @return 截取后的字符串数组
     */
    static String[] split(String str, int len) {
     ...
     * @return 是否包围，空串不包围
     */
    static boolean isSurround(String str, String prefix, String suffix) {
        if (Strs.isBlank(str)) {
            return false;
        }
     ...
     * @return 格式化后的文本
     */
    static String indexedFormat(String pattern, Object... arguments) {
     ...
     * @return 字符串
     */
    static String utf8Str(Object obj) {
     ...
     * @return 字符串
     */
    static String str(Object obj, Charset charset) {
        if (null == obj) {
            return null;
        }
     ...
     * @return 解码后的字符串
     */
    static String str(byte[] data, Charset charset) {
        if (data == null) {
            return null;
        }
     ...
     * @return 字符串
     */
    static String str(ByteBuffer data, Charset charset) {
        if (null == charset) {
     ...
     * @return 字符串
     */
    static String str(Object obj, String charsetName) {
     ...
     * @return 字符串
     */
    static String str(byte[] bytes, String charset) {
     ...
     * @return 字符串
     */
    static String str(ByteBuffer data, String charset) {
        if (data == null) {
            return null;
        }
    ...
    public static ByteBuffer byteBuffer(String str, String charset) {
        return ByteBuffer.wrap(Strs.bytes(str, charset));
    }
     ...
     * @return 编码后的字节码
     */
    static byte[] bytes(String str, String charset) {
     ...
     */
    static String join(String conjunction, Object... objs) {
     ...
     */
    static String toUnderlineCase(String camelCaseStr) {
